...
\title%[ACCESS-OM2]
{\textcolor{white}{{\LARGE\textbf{Southern Ocean sea ice\\ % and circulation\\ 
in a global coupled ocean-sea ice model\\ at three resolutions}}}\vspace{3ex}}
\author{\normalsize \textcolor{white}{\textbf{% identical to paper author list
\textbf{Andrew~Kiss}~{\scriptsize (ANU)}, 
Petra~Heil~{\scriptsize (AAPP,~UTas)},
Paul~Sandery~{\scriptsize (CSIRO)},
Will~Hobbs~{\scriptsize (AAPP,~UTas)},
Andy~Hogg~{\scriptsize (ANU)},
Hakase~Hayashida~{\scriptsize (UTas)},
Ryan~Holmes~{\scriptsize (UNSW)},
Abhishek~Savita~{\scriptsize (CSIRO,~UTas)}\\
and many contributors
from the COSIMA community, especially\\
Nic~Hannah~{\scriptsize (Double Precision)},
Russ~Fiedler~{\scriptsize (CSIRO)},
Aidan~Heerdegen~{\scriptsize (ANU)},
Angus~Gibson~{\scriptsize (ANU)},
Marshall~Ward~{\scriptsize (GFDL)},
Paul~Leopardi~{\scriptsize (NCI)}
}\\
\vspace{4ex}
\colorbox{white}{
\textcolor{black}{\textbf{ \href{http://cosima.org.au/}{cosima.org.au}}}\quad
\includegraphics[height=.03\textwidth]{figures/logos/Australian-National-University.png}\quad
\includegraphics[height=.03\textwidth]{figures/logos/unsw-logo.png}\quad
\includegraphics[height=.03\textwidth]{figures/logos/UTAS-Colour-Stacked.png}\quad
\includegraphics[height=.03\textwidth]{figures/logos/CSIRO_Logo.png}\quad
\includegraphics[height=.03\textwidth]{figures/logos/aad_env_inline.png}\quad
\includegraphics[height=.03\textwidth]{figures/logos/BOM_inline_black_300_41w.jpg}\quad
\includegraphics[height=.03\textwidth]{figures/logos/NCI_3D_white-background_720P.jpg}}
}\\
\textcolor{white}{{\tiny This project is supported through funding from the Australian Government's Australian Antarctic Science Grant Program and ARC Linkage.}}}
%\date{\today}
...
\textbf{Prescribed atmospheric forcing}
\begin{itemize}
\item JRA55-do~v1.4.0 reanalysis {\scriptsize (55\,km, 3-hourly)}
\item this is the only component tied to observed interannual variations
...
\item  {\small WOMBAT biogeochemistry support}\\[-4ex]
\item  {\small improved speed and scalability at 0.1$^\circ$}\\[-4ex]
\item  {\small bug fixes and configuration improvements, etc}
\end{itemize}
\end{minipage}
}

\frame{
\frametitle{The model experiments}
\begin{itemize}
...
\item No data assimilation in sea ice or ocean models\\[2ex]
\item Each resolution was run for \textbf{multiple 61-year cycles}
\begin{itemize}
\item Each cycle had 1 Jan 1958 -- 31 Dec 2018 JRA55-do v1.4 forcing
...
\includegraphics[width=\textwidth, trim=0 0 0 180, clip]{figs/ice_extent_seasonal_clim_cycle1.pdf}\\
\hfill {\scriptsize Obs: NOAA/NSIDC G02135 Sea Ice Index v3 (Fetterer et al., 2017)}\\[2ex]
\begin{itemize}
\item modelled ice extent is slightly too low at minimum (Feb)
\item very close to observed extent in March (although concentrations are too low)
\item extent rises too quickly in Autumn and falls too slowly in Spring
\end{itemize}
}
...
\item Resolution dependence is smaller than bias --- so parameter testing can be done at low resolution and benefit all resolutions
\item Unclear whether bias is mainly due to model configuration or JRA55-do forcing
...
\item Data to be made publicly available soon
\end{itemize}
\textbf{Next steps}
\begin{itemize}
\item More detailed comparison to ice and ocean observations
\item Investigate model parameter dependence to reduce model bias
\end{itemize}
}
...
\item this presentation: \url{https://www.dropbox.com/sh/mgb2x4texc5vbbg/AACGSnkaZ-1LdIfatLfBnLFSa}
\item figure plotting script: \url{https://github.com/aekiss/ice_analysis}
\item figure files: \texttt{/g/data/v45/aek156/notebooks/github/aekiss/ice_analysis/figs}
\end{itemize}
}
...
\frame{
\frametitle{Thoughts and potential figures for AMOS 2021 presentation}
last updated  \today\ \DTMcurrenttime ; \href{https://www.dropbox.com/sh/mgb2x4texc5vbbg/AACGSnkaZ-1LdIfatLfBnLFSa}{click \textbf{here} for latest version}
\vfill
This is a work in progress. I'm just sharing some figures and thoughts for my AMOS2021 presentation. If you have any suggestions, questions, or additional analyses to suggest/provide, let me know! \href{mailto:andrew.kiss@anu.edu.au}{andrew.kiss@anu.edu.au}
\vfill
\textbf{Abstract} (FYI):
We will present an assessment of the Southern Ocean sea ice and ocean simulated by ACCESS-OM2 global coupled ocean - sea ice model configurations at 1$^\circ$, 0.25$^\circ$ and 0.1$^\circ$ resolution. We compare the model simulations to available observations and also discuss the ability of these models to represent sea ice trends, including the recent decline in Antarctic sea ice extent, and the extent to which improvements are obtained at increased horizontal resolution. We also use ensembles with identical JRA55-do atmospheric forcing but differing initial conditions to investigate the roles of ocean and atmospheric forcing on sea ice biases.
}
